...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root = '../datasets/Satellite',  # Root path of data.
        data_prefix=dict(
            img_path='img_dir/train_3',
            seg_map_path='ann_dir/train_3'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', reduce_zero_label=False),
            dict(type='RandomCrop', crop_size=(
...
test_evaluator = dict(
    ...
    format_only=True,
    output_dir='mask_inference_result/resnest_deeplabv3plus_fold3/format_results')
default_scope = 'mmseg'
env_cfg = dict(
