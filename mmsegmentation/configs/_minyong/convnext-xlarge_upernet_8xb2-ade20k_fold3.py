...
model = dict(
    ...
    auxiliary_head=[
        dict(
            ...
            in_channels=1024,  # Input channel of decode head.
...
train_dataloader = dict(
    batch_size=8,  # Batch size of a single GPU
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path='img_dir/val_slice_3', seg_map_path='ann_dir/val_slice_3'),
...
test_evaluator = dict(
    ...
    format_only=True,
    keep_results=True,
    output_dir='_satellite/upernet_convnext-xl_ver1_fold3/format_results')
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=4000, max_keep_ckpts=2, save_best='mDice'),
...
load_from = "https://download.openmmlab.com/mmsegmentation/v0.5/convnext/upernet_convnext_xlarge_fp16_640x640_160k_ade20k/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_20220226_080344-95fc38c2.pth"
