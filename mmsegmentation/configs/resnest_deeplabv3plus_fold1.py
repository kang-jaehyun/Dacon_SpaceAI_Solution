...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='data/Satellite',
        data_prefix=dict(
            img_path='img_dir/fold1_train_img',
            seg_map_path='ann_dir/fold1_train_gt'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', reduce_zero_label=False),
            dict(type='RandomCrop', crop_size=(
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='data/Satellite',
        data_prefix=dict(
            img_path='img_dir/fold1_val_img',
            seg_map_path='ann_dir/fold1_val_gt'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='Resize', scale=(
                512,
