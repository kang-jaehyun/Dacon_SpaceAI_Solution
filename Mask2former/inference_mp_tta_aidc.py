...
parser = argparse.ArgumentParser(description="Mask2Former-MP")
parser.add_argument("--config", type=str, default="", required=True)
parser.add_argument("--model", type=str, default="", required=True)
parser.add_argument("--num_process", type=int, default=4, help="Number of processes for parallel execution")
parser.add_argument("--tta", type=int, default=0, help="", required=True)
...
TTA = args.tta
OUTPUT = args.output
test_data_folder = "/home/jaehyunkang/datasets/dacon/test_img"
...
if __name__ == '__main__':
    ...
    csv_file = '/home/jaehyunkang/datasets/dacon/sample_submission.csv'
